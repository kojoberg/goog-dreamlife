                    ...
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="flex items-center space-x-2">
                            @if(config('filesystems.disks.google.clientId') && config('filesystems.disks.google.clientSecret'))
                                <span
                                    class="bg-green-100 text-green-800 text-xs font-semibold px-2.5 py-0.5 rounded flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                        <path
                                            d="M10 2a8 8 0 100 16 8 8 0 000-16zm-7 4a1 1 0 112 0 1 1 0 01-2 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z"
                            ...
                            @else
                                <span
                                    class="bg-gray-100 text-gray-800 text-xs font-semibold px-2.5 py-0.5 rounded flex items-center"
                                    title="Configure in .env">
                    ...
                    <div class="mt-4 bg-blue-50 p-4 rounded-md border-l-4 border-blue-400">
                        ...
                        @if(config('filesystems.disks.google.clientId'))
                            <p class="text-sm text-blue-700">
                                Cloud backup is <strong>ACTIVE</strong>. Backups created here are automatically uploaded to
                                the configured Google Drive folder.
                            </p>
                        @else
                            <p class="text-sm text-blue-700">
                                Cloud backup is currently <strong>DISABLED</strong>. To enable automatic upload to Google
                                Drive, please configure your Google Drive settings in the <a
                                    href="{{ route('settings.index') }}"
                                    class="text-blue-600 hover:text-blue-900 font-bold">Settings</a> page.
                            </p>
                        @endif
                    </div>
