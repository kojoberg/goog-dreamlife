...
<head>
    ...
    <title>404 - Page Not Found | Dream Life Healthcare</title>
...
<body class="bg-gray-900 text-white antialiased h-screen flex items-center justify-center overflow-hidden relative">
    ...
    <div class="relative z-10 text-center px-6">
        <h1
            class="text-9xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400 mb-4">
            404</h1>
        <h2 class="text-3xl font-bold mb-4">Page Not Found</h2>
        <p class="text-gray-400 text-lg mb-8 max-w-md mx-auto">Sorry, the page you are looking for does not exist or has
            been moved.</p>

        <a href="{{ url('/') }}"
            class="inline-flex items-center justify-center px-8 py-3 text-base font-bold text-white bg-blue-600 rounded-xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-900/20">
            Go Home
        </a>
    </div>
